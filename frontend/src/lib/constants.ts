...
export const REGISTRY_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_ephemeralPubKeyX", type: "uint256" },
      { name: "_ephemeralPubKeyY", type: "uint256" },
      { name: "_stealthPubKeyX", type: "uint256" },
      { name: "_stealthPubKeyY", type: "uint256" },
      { name: "_encryptedAmount", type: "uint256" },
      { name: "_encryptedBlinding", type: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [
      { name: "commitment", type: "uint256", indexed: true },
      { name: "ephemeralPubKeyX", type: "uint256", indexed: false },
      { name: "ephemeralPubKeyY", type: "uint256", indexed: false },
      { name: "stealthPubKeyX", type: "uint256", indexed: false },
      { name: "stealthPubKeyY", type: "uint256", indexed: false },
      { name: "encryptedAmount", type: "uint256", indexed: false },
      { name: "encryptedBlinding", type: "uint256", indexed: false },
    ],
  },
] as const;
