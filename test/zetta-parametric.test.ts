...
describe("Zetta Parametric", function () {
  // -------------------------------------------------------------------------
  // 5 deposit tests — commitment tracked after deposit
  ...
  // -------------------------------------------------------------------------
  // 5 transfer tests — nullifier marked spent after transfer
  ...
  // -------------------------------------------------------------------------
  // 5 hash tests — on-chain Poseidon determinism + output in-field
  ...
  // -------------------------------------------------------------------------
  // 5 stats tests — deposit count and total deposited match
  ...
  // -------------------------------------------------------------------------
  // 5 bound tests — valid field elements accepted as commitments
  ...
  // -------------------------------------------------------------------------
  // 5 withdraw tests — recipient balance increases by withdrawn amount
